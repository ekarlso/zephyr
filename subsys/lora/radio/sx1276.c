...
static char dio_gpio_dev_name_table[6] = {
	CONFIG_LORA_SX1276_DIO0_DEV_NAME,
	CONFIG_LORA_SX1276_DIO1_DEV_NAME,
	CONFIG_LORA_SX1276_DIO2_DEV_NAME,
	CONFIG_LORA_SX1276_DIO3_DEV_NAME,
	CONFIG_LORA_SX1276_DIO4_DEV_NAME,
	CONFIG_LORA_SX1276_DIO5_DEV_NAME,
};

static uint8_t dio_gpio_pin_table[6] = {
	CONFIG_LORA_SX1276_DIO0_PIN,
	CONFIG_LORA_SX1276_DIO1_PIN,
	CONFIG_LORA_SX1276_DIO2_PIN,
	CONFIG_LORA_SX1276_DIO3_PIN,
	CONFIG_LORA_SX1276_DIO4_PIN,
	CONFIG_LORA_SX1276_DIO5_PIN,
}
...
{
	struct device *dev = device_get_binding(CONFIG_LORA_SX1276_RESET_DEV_NAME);
	if ( NULL == dev )
	{
		return ;
	}

	gpio_pin_configure(dev, CONFIG_LORA_SX1276_RESET_PIN, GPIO_DIR_OUT | GPIO_PUD_NORMAL);
	gpio_pin_write(dev, CONFIG_LORA_SX1276_RESET_PIN, 0);

	k_sleep( 1 );

	gpio_pin_configure(dev, CONFIG_LORA_SX1276_RESET_PIN, GPIO_DIR_IN | GPIO_PUD_NORMAL);
	k_sleep( 6 );
}
