...
static const struct leuart_gecko_config leuart_gecko_0_config = {
	.base = (LEUART_TypeDef *) LEUART_0_BASE_ADDRESS,
	.clock = cmuClock_LEUART0,
	.baud_rate = LEUART_0_CURRENT_SPEED,
	.pin_rx = PIN_LEUART0_RXD,
	.pin_tx = PIN_LEUART0_TXD,
	.loc = LEUART_0_LOCATION,
#ifdef CONFIG_UART_INTERRUPT_DRIVEN
...
DEVICE_AND_API_INIT(leuart_0, LEUART_0_LABEL, &leuart_gecko_init,
...
static void leuart_gecko_config_func_0(struct device *dev)
{
	IRQ_CONNECT(LEUART_0_IRQ, LEUART_0_IRQ_PRIORITY, leuart_gecko_isr,
		    DEVICE_GET(leuart_0), 0);

	irq_enable(LEUART_0_IRQ);
}
#endif
...
static const struct leuart_gecko_config leuart_gecko_1_config = {
	.base = (LEUART_TypeDef *) LEUART_1_BASE_ADDRESS,
	.clock = cmuClock_LEUART0,
	.baud_rate = LEUART_1_CURRENT_SPEED,
	.pin_rx = PIN_LEUART1_RXD,
	.pin_tx = PIN_LEUART1_TXD,
	.loc = LEUART_1_LOCATION,
#ifdef CONFIG_UART_INTERRUPT_DRIVEN
...
DEVICE_AND_API_INIT(leuart_1, LEUART_1_LABEL, &leuart_gecko_init,
...
static void leuart_gecko_config_func_1(struct device *dev)
{
	IRQ_CONNECT(LEUART_1_IRQ, LEUART_1_IRQ_PRIORITY, leuart_gecko_isr,
		    DEVICE_GET(leuart_1), 0);

	irq_enable(LEUART_1_IRQ);
}
#endif
